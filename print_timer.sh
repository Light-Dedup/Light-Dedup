...
make
sudo bash setup.sh
sudo fio -filename=/mnt/pmem/test1 -direct=1 -iodepth 1 -rw=write -ioengine=sync -bs=4K -thread -numjobs=1 -size=15G -name=randrw --dedupe_percentage=80 -group_reporting
